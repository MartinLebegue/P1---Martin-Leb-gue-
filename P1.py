...
def scrap_infos(book_url):
    ...
    # Nettoyage du titre pour l'utiliser dans un nom de fichier
    titre_clean = re.sub(r'[\\/*?:"<>|]', "", titre)[:50]  # Exemple de nettoyage basique

    # Création du chemin du dossier basé sur le nom de la catégorie
    ...
    if response_img.status_code == 200:
        ...
        # Construire un nom de fichier informatif avec catégorie et titre
        img_filename = f"{category_name}_{titre_clean}.jpg".replace(' ', '_')
